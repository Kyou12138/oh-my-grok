...
**omo-style agent harness + Superpowers methodology for [Grok Build](https://x.ai).** · **v1.1.19** (aligned with [grok-build](https://github.com/xai-org/grok-build) + omo issues)
