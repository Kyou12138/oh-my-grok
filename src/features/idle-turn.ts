...
const FLUFF =
  /^(ok|okay|sure|sure thing|yes|no|done|thanks|thank you|thx|ty|yep|yup|nope|cool|great|perfect|awesome|noted|alright|lgtm|sgtm|wfm|wip|continue|resuming|resume|all set|all good|all clear|all done|ship it|shipping|you got it|can do|no problem|no worries|no issue|fine|fine by me|works for me|that works|that works for me|looks good to me|looks good|looking good|sounds good|sounds great|good enough|nothing to do|no changes needed|no further action|that's it|that is all|that is it|gotcha|makes sense|fair enough|clear|roger|roger that|copy|copy that|affirmative|10-4|will do|on it|got it|nice|sweet|solid|excellent|wonderful|fantastic|finished|complete|completed|ready when you are|you bet|absolutely|definitely|for sure|of course|np|kk|later|ttyl|bye|goodbye|cheers|no rush|no hurry|anytime|any time|my pleasure|happy to help|glad to help|no sweat|no biggie|standing by|let me know|ping me|继续|继续吧|好的|好的呀|好哒|好吧|好嘞|好滴|好了|好的[，,]?继续|嗯|嗯嗯|嗯呐|哦|哦哦|行|行吧|可以|可以了|可以可以|收到|收到[，,]?继续|明白|了解|知道了|懂了|懂|我明白了|我懂了|稍后|一会|没问题|没问题了|没问题的|了解了|着手处理|搞定|搞定了|弄好了|改好了|已经好了|完事了|结束了|这就办|就这样|那就这样|先这样吧|先到这里|就到这里|到这里|够了|看起来没问题|不急|慢慢来|随意|对的|没错|是的|好的呢|好的哦|好的哈|如上所述|完成|\.{1,6}|…+|👍|✅)[.。!?！？,]?$/i;
